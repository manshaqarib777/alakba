...
<div class="row">
  <div class="col-md-8 nopadding-right">
    <div class="form-group">
      ...
      {!! Form::select('country_ids[]', $frontend_countries , null, ['id' => 'country_ids', 'class' => 'form-control select2-multi', 'multiple' => 'multiple', (isset($shipping_zone) && $shipping_zone->rest_of_the_world) ? 'disabled' : 'required']) !!}
