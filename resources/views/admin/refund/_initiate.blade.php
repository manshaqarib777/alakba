        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::number('amount', isset($order) && $order->dispute && $order->dispute->refund_amount ? get_formated_decimal($order->dispute->refund_amount, true, $order->shop->country->currency->decimals) : null, ['class' => 'form-control', 'step' => 'any', 'placeholder' => trans('app.placeholder.refund_amount'), 'required']) !!}
                </div>
