  ...
  <nav class="navbar navbar-static-top" role="navigation">
    ...
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav">
        ...
        @if(Auth::user()->isMerchant() && is_incevio_package_loaded('wallet'))
          <li class="dropdown tasks-menu" id="wallet-dropdown">
            <a href="{{ route(config('wallet.routes.wallet')) }}">
              ...
              {{ get_formated_currency(Auth::user()->shop->balance, Auth::user()->shop->country->currency->decimals) }}
            </a>
          </li>
        @endif
        ...
        <li>
            <a href="{{ Request::session()->has('impersonated') ? route('admin.secretLogout') : route('logout') }}"><i class="fa fa-sign-out"></i> {{ trans('app.log_out') }}</a>
        </li>
